...
/* ORIENTATIONS */
//rotate 360*clock*y
#declare ObjectRotationLeft = <90,30,180>; 
#declare ObjectRotationRight = <90,-30,180>; 
#declare ObjectRotationFront = <90,0,180>;

#declare CameraDistance = __DISTANCE;
...
camera {
  ...
  right <-__WIDTH/__MIN,0,0>*0.7
  //right <-1,0,0>*0.7
  //right <-1.33,0,0>*0.7

  up <0,__HEIGHT/__MIN,0>*0.7
  //up <0,1,0>*0.7
  // Left right: -1.33 1
  // Top bottom: -1 1.33
  // Front back: -1 1.00
