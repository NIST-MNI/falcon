 ...
 *
 * int niik_tri_tri_intersect(double V0[3],double V1[3],double V2[3],
 ...
 * int niik_tri_tri_intersect_with_isectline(double V0[3],double V1[3],double V2[3],
 ...
 *
 *
 * modified by Kunio Nakamura
 * March 1, 2012
 * -everything is double precision float
 *
 * adapted to igl by V.S. Fonov
 */

#ifndef _TRITRI_ISECT_H_
#define _TRITRI_ISECT_H_
...
#define EPSILON 1e-8 /* 1e-6 = 0.000001 */
...
#define COMPUTE_INTERVALS(VV0,VV1,VV2,D0,D1,D2,D0D1,D0D2,isect0,isect1) \
  ...
  {                                                     \
    ...
    return niik_coplanar_tri_tri(N1,V0,V1,V2,U0,U1,U2);      \
  }
...
inline static int niik_coplanar_tri_tri(double N[3],double V0[3],double V1[3],double V2[3],
                                        double U0[3],double U1[3],double U2[3]) {
  double A[3];
  short i0,i1;
...
inline static int niik_tri_tri_intersect(double V0[3],double V1[3],double V2[3],
    double U0[3],double U1[3],double U2[3]) {
  double E1[3],E2[3];
...
inline static int NoDivTriTriIsect(double V0[3],double V1[3],double V2[3],
                                   double U0[3],double U1[3],double U2[3]) {
  double E1[3],E2[3];
  double N1[3],N2[3],d1,d2;
  double du0,du1,du2,dv0,dv1,dv2;
...
inline static void isect2(double VTX0[3],double VTX1[3],double VTX2[3],double VV0,double VV1,double VV2,
...
inline  static  int compute_intervals_isectline(double VERT0[3],double VERT1[3],double VERT2[3],
...
else if(D2!=0.0f)                                     \
{
  ...
  inline static int niik_tri_tri_intersect_with_isectline(double V0[3],double V1[3],double V2[3],
      double U0[3],double U1[3],double U2[3],int *coplanar,
      double isectpt1[3],double isectpt2[3]) {
  double E1[3],E2[3];
  double N1[3],N2[3],d1,d2;
  ...
  isectpointB1[0]=isectpointB1[1]=isectpointB1[2]=0;
  isectpointB2[0]=isectpointB2[1]=isectpointB2[2]=0;
  isect2[0]=isect2[1]=0;
  ...
  *coplanar=compute_intervals_isectline(V0,V1,V2,vp0,vp1,vp2,dv0,dv1,dv2,
  ...
  if(*coplanar) return niik_coplanar_tri_tri(N1,V0,V1,V2,U0,U1,U2);
...
#endif /* _FALCON_TRITRI_INLINE_H_ */
